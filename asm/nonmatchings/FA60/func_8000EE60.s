...
/* FA98 8000EE98 C6440000 */  lwc1       $f4, ($s2)
...
/* FAA8 8000EEA8 3C013F80 */  lui        $at, 0x3f80
/* FAAC 8000EEAC 44813000 */  mtc1       $at, $f6
/* FAB0 8000EEB0 326F0001 */  andi       $t7, $s3, 1
/* FAB4 8000EEB4 E6540000 */  swc1       $f20, ($s2)
/* FAB8 8000EEB8 E64E0004 */  swc1       $f14, 4($s2)
/* FABC 8000EEBC E6560008 */  swc1       $f22, 8($s2)
...
/* FB10 8000EF10 C6540000 */  lwc1       $f20, ($s2)
/* FB14 8000EF14 10000013 */  b          .L8000EF64
/* FB18 8000EF18 C6560008 */   lwc1      $f22, 8($s2)
.L8000EF1C:
/* FB1C 8000EF1C 30480002 */  andi       $t0, $v0, 2
...
/* FB5C 8000EF5C C6540000 */  lwc1       $f20, ($s2)
/* FB60 8000EF60 C6560008 */  lwc1       $f22, 8($s2)
.L8000EF64:
...
/* FBDC 8000EFDC 95090000 */  lhu        $t1, ($t0)
/* FBE0 8000EFE0 00095040 */  sll        $t2, $t1, 1
/* FBE4 8000EFE4 014B8821 */  addu       $s1, $t2, $t3
.L8000EFE8:
/* FBE8 8000EFE8 0462001D */  bltzl      $v1, .L8000F060
/* FBEC 8000EFEC 94500002 */   lhu       $s0, 2($v0)
/* FBF0 8000EFF0 844C0004 */  lh         $t4, 4($v0)
/* FBF4 8000EFF4 006C082A */  slt        $at, $v1, $t4
/* FBF8 8000EFF8 50200019 */  beql       $at, $zero, .L8000F060
/* FBFC 8000EFFC 94500002 */   lhu       $s0, 2($v0)
/* FC00 8000F000 04A20017 */  bltzl      $a1, .L8000F060
/* FC04 8000F004 94500002 */   lhu       $s0, 2($v0)
/* FC08 8000F008 844D0006 */  lh         $t5, 6($v0)
/* FC0C 8000F00C 00AD082A */  slt        $at, $a1, $t5
/* FC10 8000F010 50200013 */  beql       $at, $zero, .L8000F060
/* FC14 8000F014 94500002 */   lhu       $s0, 2($v0)
/* FC18 8000F018 96300000 */  lhu        $s0, ($s1)
/* FC1C 8000F01C 26310002 */  addiu      $s1, $s1, 2
/* FC20 8000F020 5200000F */  beql       $s0, $zero, .L8000F060
/* FC24 8000F024 94500002 */   lhu       $s0, 2($v0)
/* FC28 8000F028 96270000 */  lhu        $a3, ($s1)
.L8000F02C:
...
/* FC84 8000F084 26310002 */   addiu     $s1, $s1, 2
/* FC88 8000F088 14400003 */  bnez       $v0, .L8000F098
/* FC8C 8000F08C 2610FFFF */   addiu     $s0, $s0, -1
/* FC90 8000F090 5600FFF7 */  bnel       $s0, $zero, .L8000F070
/* FC94 8000F094 96270000 */   lhu       $a3, ($s1)
.L8000F098:
