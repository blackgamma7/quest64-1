...
/* 3E60C 8003DA0C 3C0EA460 */  lui        $t6, %hi(PI_STATUS_REG)
/* 3E610 8003DA10 8DCF0010 */  lw         $t7, %lo(PI_STATUS_REG)($t6)
/* 3E614 8003DA14 31F80003 */  andi       $t8, $t7, 3
/* 3E618 8003DA18 13000008 */  beqz       $t8, .L8003DA3C
/* 3E61C 8003DA1C AFAF002C */   sw        $t7, 0x2c($sp)
.L8003DA20:
/* 3E620 8003DA20 3C19A460 */  lui        $t9, %hi(PI_STATUS_REG)
/* 3E624 8003DA24 8F280010 */  lw         $t0, %lo(PI_STATUS_REG)($t9)
...
/* 3E6FC 8003DAFC 3C19A460 */  lui        $t9, %hi(PI_BSD_DOM2_LAT_REG)
/* 3E700 8003DB00 AF380024 */  sw         $t8, %lo(PI_BSD_DOM2_LAT_REG)($t9)
.L8003DB04:
...
/* 3E71C 8003DB1C 3C0CA460 */  lui        $t4, %hi(PI_BSD_DOM2_PGS_REG)
/* 3E720 8003DB20 AD8D002C */  sw         $t5, %lo(PI_BSD_DOM2_PGS_REG)($t4)
.L8003DB24:
...
/* 3E73C 8003DB3C 3C19A460 */  lui        $t9, %hi(PI_BSD_DOM2_RLS_REG)
/* 3E740 8003DB40 AF380030 */  sw         $t8, %lo(PI_BSD_DOM2_RLS_REG)($t9)
.L8003DB44:
...
/* 3E75C 8003DB5C 3C0CA460 */  lui        $t4, %hi(PI_BSD_DOM2_PWD_REG)
/* 3E760 8003DB60 AD8D0028 */  sw         $t5, %lo(PI_BSD_DOM2_PWD_REG)($t4)
.L8003DB64:
/* 3E764 8003DB64 8FAF0028 */  lw         $t7, 0x28($sp)
/* 3E768 8003DB68 8FAE0030 */  lw         $t6, 0x30($sp)
/* 3E76C 8003DB6C 3C018007 */  lui        $at, %hi(__osCurrentHandle)
/* 3E770 8003DB70 000F5880 */  sll        $t3, $t7, 2
/* 3E774 8003DB74 002B0821 */  addu       $at, $at, $t3
/* 3E778 8003DB78 AC2EF440 */  sw         $t6, %lo(__osCurrentHandle)($at)
.L8003DB7C:
...
/* 3E7A0 8003DBA0 3C0CA460 */  lui        $t4, %hi(PI_CART_ADDR_REG)
/* 3E7A4 8003DBA4 01095025 */  or         $t2, $t0, $t1
/* 3E7A8 8003DBA8 01416824 */  and        $t5, $t2, $at
/* 3E7AC 8003DBAC AD8D0004 */  sw         $t5, %lo(PI_CART_ADDR_REG)($t4)
...
/* 3E7D0 8003DBD0 3C0BA460 */  lui        $t3, %hi(PI_WR_LEN_REG)
/* 3E7D4 8003DBD4 25EEFFFF */  addiu      $t6, $t7, -1
/* 3E7D8 8003DBD8 10000008 */  b          .L8003DBFC
/* 3E7DC 8003DBDC AD6E000C */   sw        $t6, %lo(PI_WR_LEN_REG)($t3)
.L8003DBE0:
/* 3E7E0 8003DBE0 8FB80040 */  lw         $t8, 0x40($sp)
/* 3E7E4 8003DBE4 3C08A460 */  lui        $t0, %hi(PI_RD_LEN_REG)
/* 3E7E8 8003DBE8 2719FFFF */  addiu      $t9, $t8, -1
/* 3E7EC 8003DBEC 10000003 */  b          .L8003DBFC
/* 3E7F0 8003DBF0 AD190008 */   sw        $t9, %lo(PI_RD_LEN_REG)($t0)
.L8003DBF4:
