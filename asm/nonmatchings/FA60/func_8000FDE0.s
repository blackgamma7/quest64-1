...
/* 10A18 8000FE18 3C0E8009 */  lui        $t6, %hi(BattleState)
/* 10A1C 8000FE1C 8C430008 */  lw         $v1, 8($v0)
/* 10A20 8000FE20 10600006 */  beqz       $v1, .L8000FE3C
/* 10A24 8000FE24 00000000 */   nop
/* 10A28 8000FE28 95CEC592 */  lhu        $t6, %lo(BattleState)($t6)
/* 10A2C 8000FE2C 00609025 */  or         $s2, $v1, $zero
/* 10A30 8000FE30 31CF0001 */  andi       $t7, $t6, 1
...
/* 10A48 8000FE48 8C500004 */   lw        $s0, 4($v0)
...
/* 10ACC 8000FECC 2652FFFF */   addiu     $s2, $s2, -1
...
.L8000FF0C:
/* 10B0C 8000FF0C 0C004020 */  jal        UNK_calledWhenGettingNearDoor_RENAME
/* 10B10 8000FF10 02002025 */   or        $a0, $s0, $zero
/* 10B14 8000FF14 24080001 */  addiu      $t0, $zero, 1
/* 10B18 8000FF18 10000004 */  b          .L8000FF2C
/* 10B1C 8000FF1C AFA80040 */   sw        $t0, 0x40($sp)
/* 10B20 8000FF20 2652FFFF */  addiu      $s2, $s2, -1
.L8000FF24:
