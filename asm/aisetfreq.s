...
/* 372C0 800366C0 3C0E8007 */  lui        $t6, %hi(osViClock)
/* 372C4 800366C4 8DCEF408 */  lw         $t6, %lo(osViClock)($t6)
...
/* 372E0 800366E0 3C014F80 */  lui        $at, 0x4f80
...
/* 372F4 800366F4 3C013F00 */  lui        $at, 0x3f00
/* 372F8 800366F8 44812000 */  mtc1       $at, $f4
/* 372FC 800366FC 24050001 */  addiu      $a1, $zero, 1
...
/* 3734C 8003674C 30A10004 */  andi       $at, $a1, 4
...
/* 37398 80036798 2402FFFF */   addiu     $v0, $zero, -1
.L8003679C:
...
.L800367C0:
/* 373C0 800367C0 24B9FFFF */  addiu      $t9, $a1, -1
/* 373C4 800367C4 3C08A450 */  lui        $t0, %hi(AI_DACRATE_REG)
/* 373C8 800367C8 AD190010 */  sw         $t9, %lo(AI_DACRATE_REG)($t0)
/* 373CC 800367CC 24C9FFFF */  addiu      $t1, $a2, -1
/* 373D0 800367D0 3C0AA450 */  lui        $t2, %hi(AI_BITRATE_REG)
/* 373D4 800367D4 AD490014 */  sw         $t1, %lo(AI_BITRATE_REG)($t2)
/* 373D8 800367D8 240B0001 */  addiu      $t3, $zero, 1
/* 373DC 800367DC 3C0CA450 */  lui        $t4, %hi(AI_CONTROL_REG)
/* 373E0 800367E0 AD8B0008 */  sw         $t3, %lo(AI_CONTROL_REG)($t4)
/* 373E4 800367E4 3C0D8007 */  lui        $t5, %hi(osViClock)
/* 373E8 800367E8 8DADF408 */  lw         $t5, %lo(osViClock)($t5)
...
.L80036800:
/* 37400 80036800 2401FFFF */   addiu     $at, $zero, -1
/* 37404 80036804 14A10004 */  bne        $a1, $at, .L80036818
/* 37408 80036808 3C018000 */   lui       $at, 0x8000
...
glabel alUnlink
/* 37420 80036820 8C820000 */  lw         $v0, ($a0)
/* 37424 80036824 50400004 */  beql       $v0, $zero, .L80036838
/* 37428 80036828 8C820004 */   lw        $v0, 4($a0)
/* 3742C 8003682C 8C8E0004 */  lw         $t6, 4($a0)
/* 37430 80036830 AC4E0004 */  sw         $t6, 4($v0)
/* 37434 80036834 8C820004 */  lw         $v0, 4($a0)
.L80036838:
/* 37438 80036838 10400003 */  beqz       $v0, .L80036848
/* 3743C 8003683C 00000000 */   nop
/* 37440 80036840 8C8F0000 */  lw         $t7, ($a0)
/* 37444 80036844 AC4F0000 */  sw         $t7, ($v0)
.L80036848:
/* 37448 80036848 03E00008 */  jr         $ra
/* 3744C 8003684C 00000000 */   nop

glabel alLink
/* 37450 80036850 8CAE0000 */  lw         $t6, ($a1)
/* 37454 80036854 AC850004 */  sw         $a1, 4($a0)
/* 37458 80036858 AC8E0000 */  sw         $t6, ($a0)
/* 3745C 8003685C 8CA20000 */  lw         $v0, ($a1)
/* 37460 80036860 10400002 */  beqz       $v0, .L8003686C
/* 37464 80036864 00000000 */   nop
/* 37468 80036868 AC440004 */  sw         $a0, 4($v0)
.L8003686C:
/* 3746C 8003686C 03E00008 */  jr         $ra
/* 37470 80036870 ACA40000 */   sw        $a0, ($a1)

glabel alClose
/* 37474 80036874 3C0E8007 */  lui        $t6, %hi(alGlobals)
/* 37478 80036878 8DCE0990 */  lw         $t6, %lo(alGlobals)($t6)
...
/* 37494 80036894 3C018007 */  lui        $at, %hi(alGlobals)
/* 37498 80036898 AC200990 */  sw         $zero, %lo(alGlobals)($at)
...
glabel alInit
/* 374AC 800368AC 3C028007 */  lui        $v0, %hi(alGlobals)
/* 374B0 800368B0 24420990 */  addiu      $v0, $v0, %lo(alGlobals)
/* 374B4 800368B4 8C4E0000 */  lw         $t6, ($v0)
...
/* 374CC 800368CC AC440000 */   sw        $a0, ($v0)
