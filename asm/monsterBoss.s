...
glabel LoadAndSpawnBoss
/* C130 8000B530 27BDFFC0 */  addiu      $sp, $sp, -0x40
/* C134 8000B534 AFBF0024 */  sw         $ra, 0x24($sp)
/* C138 8000B538 AFB00020 */  sw         $s0, 0x20($sp)
/* C13C 8000B53C 3C018008 */  lui        $at, %hi(CurrBossSpawned)
/* C140 8000B540 3C03803B */  lui        $v1, 0x803b
/* C144 8000B544 3C028008 */  lui        $v0, %hi(nextMap)
/* C148 8000B548 3C048008 */  lui        $a0, %hi(nextSubmap)
/* C14C 8000B54C AC20D1A0 */  sw         $zero, %lo(CurrBossSpawned)($at)
/* C150 8000B550 24844EE8 */  addiu      $a0, $a0, %lo(nextSubmap)
/* C154 8000B554 8C424EE4 */  lw         $v0, %lo(nextMap)($v0)
/* C158 8000B558 24639AD0 */  addiu      $v1, $v1, -0x6530
/* C15C 8000B55C 00008025 */  or         $s0, $zero, $zero
/* C160 8000B560 24050008 */  addiu      $a1, $zero, 8
.L8000B564:
/* C164 8000B564 946E0000 */  lhu        $t6, ($v1)
/* C168 8000B568 544E0024 */  bnel       $v0, $t6, .L8000B5FC
/* C16C 8000B56C 26100001 */   addiu     $s0, $s0, 1
/* C170 8000B570 8C8F0000 */  lw         $t7, ($a0)
/* C174 8000B574 94780002 */  lhu        $t8, 2($v1)
...
/* C194 8000B594 94790004 */  lhu        $t9, 4($v1)
/* C198 8000B598 3C09803B */  lui        $t1, %hi(tbl_bossRomOffsets)
/* C19C 8000B59C 25299A90 */  addiu      $t1, $t1, %lo(tbl_bossRomOffsets)
/* C1A0 8000B5A0 001940C0 */  sll        $t0, $t9, 3
/* C1A4 8000B5A4 01091021 */  addu       $v0, $t0, $t1
/* C1A8 8000B5A8 8C440000 */  lw         $a0, ($v0)
/* C1AC 8000B5AC 8C470004 */  lw         $a3, 4($v0)
/* C1B0 8000B5B0 3C05802A */  lui        $a1, %hi(vram_bossFile)
/* C1B4 8000B5B4 24A57BC0 */  addiu      $a1, $a1, %lo(vram_bossFile)
/* C1B8 8000B5B8 AFA30028 */  sw         $v1, 0x28($sp)
/* C1BC 8000B5BC 0C009098 */  jal        loadData
...
/* C1F4 8000B5F4 AC2BD1A0 */   sw        $t3, %lo(CurrBossSpawned)($at)
/* C1F8 8000B5F8 26100001 */  addiu      $s0, $s0, 1
.L8000B5FC:
...
/* C224 8000B624 3C0E8008 */  lui        $t6, %hi(CurrBossSpawned)
/* C228 8000B628 8DCED1A0 */  lw         $t6, %lo(CurrBossSpawned)($t6)
...
/* C238 8000B638 3C0A8008 */   lui       $t2, %hi(DLPtr)
/* C23C 8000B63C 852F0074 */  lh         $t7, 0x74($t1)
/* C240 8000B640 3C08803B */  lui        $t0, %hi(tbl_MonsterNames)
/* C244 8000B644 254AB2FC */  addiu      $t2, $t2, %lo(DLPtr)
/* C248 8000B648 000FC080 */  sll        $t8, $t7, 2
/* C24C 8000B64C 01184021 */  addu       $t0, $t0, $t8
/* C250 8000B650 8D08A164 */  lw         $t0, %lo(tbl_MonsterNames)($t0)
/* C254 8000B654 8D430000 */  lw         $v1, ($t2)
/* C258 8000B658 3C0BBA00 */  lui        $t3, 0xba00
/* C25C 8000B65C 356B0C02 */  ori        $t3, $t3, 0xc02
/* C260 8000B660 24790008 */  addiu      $t9, $v1, 8
/* C264 8000B664 AD590000 */  sw         $t9, ($t2)
/* C268 8000B668 240C2000 */  addiu      $t4, $zero, 0x2000
/* C26C 8000B66C AC6C0004 */  sw         $t4, 4($v1)
/* C270 8000B670 AC6B0000 */  sw         $t3, ($v1)
/* C274 8000B674 852D0076 */  lh         $t5, 0x76($t1)
/* C278 8000B678 3C058008 */  lui        $a1, %hi(bossActor)
/* C27C 8000B67C 24A5D1CC */  addiu      $a1, $a1, %lo(bossActor)
...
/* C290 8000B690 24040001 */  addiu      $a0, $zero, 1
/* C294 8000B694 0C0076CE */  jal        func_8001DB38
/* C298 8000B698 AFA8002C */   sw        $t0, 0x2c($sp)
/* C29C 8000B69C 3C0F8008 */  lui        $t7, %hi(bossActor+0x52)
/* C2A0 8000B6A0 85EFD21E */  lh         $t7, %lo(bossActor+0x52)($t7)
/* C2A4 8000B6A4 8FA8002C */  lw         $t0, 0x2c($sp)
/* C2A8 8000B6A8 3C048008 */  lui        $a0, 0x8008
/* C2AC 8000B6AC 000FC080 */  sll        $t8, $t7, 2
/* C2B0 8000B6B0 030FC023 */  subu       $t8, $t8, $t7
/* C2B4 8000B6B4 0018C080 */  sll        $t8, $t8, 2
/* C2B8 8000B6B8 3C058008 */  lui        $a1, %hi(bossActor)
/* C2BC 8000B6BC 24A5D1CC */  addiu      $a1, $a1, %lo(bossActor)
/* C2C0 8000B6C0 9484D224 */  lhu        $a0, -0x2ddc($a0)
/* C2C4 8000B6C4 0C00782B */  jal        animateBrian
/* C2C8 8000B6C8 03083021 */   addu      $a2, $t8, $t0
/* C2CC 8000B6CC 3C198008 */  lui        $t9, %hi(bossActor+0x64)
/* C2D0 8000B6D0 8F39D230 */  lw         $t9, %lo(bossActor+0x64)($t9)
/* C2D4 8000B6D4 24010002 */  addiu      $at, $zero, 2
/* C2D8 8000B6D8 972B0000 */  lhu        $t3, ($t9)
/* C2DC 8000B6DC 11610014 */  beq        $t3, $at, .L8000B730
/* C2E0 8000B6E0 3C018008 */   lui       $at, %hi(bossActor)
/* C2E4 8000B6E4 C42CD1CC */  lwc1       $f12, %lo(bossActor)($at)
/* C2E8 8000B6E8 3C018008 */  lui        $at, %hi(bossActor+0x4)
/* C2EC 8000B6EC C42ED1D0 */  lwc1       $f14, %lo(bossActor+0x4)($at)
/* C2F0 8000B6F0 3C018008 */  lui        $at, %hi(bossActor+0x30)
/* C2F4 8000B6F4 C424D1FC */  lwc1       $f4, %lo(bossActor+0x30)($at)
/* C2F8 8000B6F8 3C018008 */  lui        $at, %hi(bossActor+0x34)
/* C2FC 8000B6FC C426D200 */  lwc1       $f6, %lo(bossActor+0x34)($at)
/* C300 8000B700 3C018008 */  lui        $at, %hi(bossActor+0x28)
/* C304 8000B704 C428D1F4 */  lwc1       $f8, %lo(bossActor+0x28)($at)
/* C308 8000B708 C42AD1F0 */  lwc1       $f10, -0x2e10($at)
/* C30C 8000B70C 3C068008 */  lui        $a2, %hi(bossZPos)
/* C310 8000B710 3C078008 */  lui        $a3, %hi(bossActor+0x2C)
/* C314 8000B714 460A4402 */  mul.s      $f16, $f8, $f10
/* C318 8000B718 8CE7D1F8 */  lw         $a3, %lo(bossActor+0x2C)($a3)
...
glabel returnBossIDIfBrianInRange
/* C340 8000B740 27BDFFE0 */  addiu      $sp, $sp, -0x20
/* C344 8000B744 AFBF0014 */  sw         $ra, 0x14($sp)
/* C348 8000B748 3C0E8008 */  lui        $t6, %hi(CurrBossSpawned)
/* C34C 8000B74C 8DCED1A0 */  lw         $t6, %lo(CurrBossSpawned)($t6)
...
/* C360 8000B760 3C048008 */  lui        $a0, %hi(brianAction)
/* C364 8000B764 2484BAB8 */  addiu      $a0, $a0, %lo(brianAction)
...
/* C5E4 8000B9E4 3C198008 */  lui        $t9, %hi(bossSpawnData)
/* C5E8 8000B9E8 0338C821 */  addu       $t9, $t9, $t8
/* C5EC 8000B9EC 01EE7821 */  addu       $t7, $t7, $t6
/* C5F0 8000B9F0 91EFD740 */  lbu        $t7, %lo(binTbl)($t7)
/* C5F4 8000B9F4 9339D19C */  lbu        $t9, %lo(bossSpawnData)($t9)
...
glabel setBossSpawnFlag
/* C60C 8000BA0C AFA40000 */  sw         $a0, ($sp)
/* C610 8000BA10 308EFFFF */  andi       $t6, $a0, 0xffff
/* C614 8000BA14 01C02025 */  or         $a0, $t6, $zero
/* C618 8000BA18 3C188008 */  lui        $t8, %hi(bossSpawnData)
/* C61C 8000BA1C 2718D19C */  addiu      $t8, $t8, %lo(bossSpawnData)
/* C620 8000BA20 000478C3 */  sra        $t7, $a0, 3
/* C624 8000BA24 30880007 */  andi       $t0, $a0, 7
/* C628 8000BA28 3C098005 */  lui        $t1, %hi(binTbl)
/* C62C 8000BA2C 01284821 */  addu       $t1, $t1, $t0
/* C630 8000BA30 01F81821 */  addu       $v1, $t7, $t8
/* C634 8000BA34 90790000 */  lbu        $t9, ($v1)
/* C638 8000BA38 9129D740 */  lbu        $t1, %lo(binTbl)($t1)
/* C63C 8000BA3C 03295025 */  or         $t2, $t9, $t1
/* C640 8000BA40 A06A0000 */  sb         $t2, ($v1)
...
/* C6D8 8000BAD8 3C098008 */  lui        $t1, %hi(bossActor)
/* C6DC 8000BADC 24A5D130 */  addiu      $a1, $a1, %lo(bossZoomCamXPos)
/* C6E0 8000BAE0 2529D1CC */  addiu      $t1, $t1, %lo(bossActor)
