...
/* 37C14 80037014 3C0F8007 */  lui        $t7, %hi(hdwrBugFlag)
/* 37C18 80037018 91EF09A0 */  lbu        $t7, %lo(hdwrBugFlag)($t7)
...
/* 37C58 80037058 240B0001 */  addiu      $t3, $zero, 1
/* 37C5C 8003705C 3C018007 */  lui        $at, %hi(hdwrBugFlag)
/* 37C60 80037060 10000003 */  b          .L80037070
/* 37C64 80037064 A02B09A0 */   sb        $t3, %lo(hdwrBugFlag)($at)
.L80037068:
/* 37C68 80037068 3C018007 */  lui        $at, %hi(hdwrBugFlag)
/* 37C6C 8003706C A02009A0 */  sb         $zero, %lo(hdwrBugFlag)($at)
.L80037070:
...
/* 37C84 80037084 2402FFFF */   addiu     $v0, $zero, -1
.L80037088:
/* 37C88 80037088 0C00D374 */  jal        osVirtualToPhysical
/* 37C8C 8003708C 8FA4001C */   lw        $a0, 0x1c($sp)
/* 37C90 80037090 3C0CA450 */  lui        $t4, 0xa450
/* 37C94 80037094 AD820000 */  sw         $v0, ($t4)
/* 37C98 80037098 8FAD0024 */  lw         $t5, 0x24($sp)
/* 37C9C 8003709C 3C0FA450 */  lui        $t7, %hi(AI_LEN_REG)
/* 37CA0 800370A0 00001025 */  or         $v0, $zero, $zero
/* 37CA4 800370A4 ADED0004 */  sw         $t5, %lo(AI_LEN_REG)($t7)
.L800370A8:
