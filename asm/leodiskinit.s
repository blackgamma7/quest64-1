...
/* 3E254 8003D654 3C018009 */  lui        $at, %hi(LeoDiskHandle_type)
/* 3E258 8003D658 A02E5564 */  sb         $t6, %lo(LeoDiskHandle_type)($at)
/* 3E25C 8003D65C 3C018009 */  lui        $at, %hi(LeoDiskHandle_baseAddress)
/* 3E260 8003D660 3C0FA500 */  lui        $t7, 0xa500
/* 3E264 8003D664 AC2F556C */  sw         $t7, %lo(LeoDiskHandle_baseAddress)($at)
/* 3E268 8003D668 3C018009 */  lui        $at, %hi(LeoDiskHandle_latency)
/* 3E26C 8003D66C 24180003 */  addiu      $t8, $zero, 3
/* 3E270 8003D670 A0385565 */  sb         $t8, %lo(LeoDiskHandle_latency)($at)
/* 3E274 8003D674 3C018009 */  lui        $at, %hi(LeoDiskHandle_pulse)
/* 3E278 8003D678 24190006 */  addiu      $t9, $zero, 6
/* 3E27C 8003D67C A0395568 */  sb         $t9, %lo(LeoDiskHandle_pulse)($at)
/* 3E280 8003D680 3C018009 */  lui        $at, %hi(LeoDiskHandle_pageSize)
/* 3E284 8003D684 24080006 */  addiu      $t0, $zero, 6
/* 3E288 8003D688 24090002 */  addiu      $t1, $zero, 2
/* 3E28C 8003D68C A0285566 */  sb         $t0, %lo(LeoDiskHandle_pageSize)($at)
/* 3E290 8003D690 A0295567 */  sb         $t1, 0x5567($at)
/* 3E294 8003D694 27BDFFE0 */  addiu      $sp, $sp, -0x20
/* 3E298 8003D698 3C018009 */  lui        $at, %hi(LeoDiskHandle_domain)
/* 3E29C 8003D69C 240A0001 */  addiu      $t2, $zero, 1
/* 3E2A0 8003D6A0 AFBF0014 */  sw         $ra, 0x14($sp)
/* 3E2A4 8003D6A4 A02A5569 */  sb         $t2, %lo(LeoDiskHandle_domain)($at)
...
/* 3E2B4 8003D6B4 3C0D8009 */  lui        $t5, %hi(LeoDiskHandle_pulse)
/* 3E2B8 8003D6B8 91AD5568 */  lbu        $t5, %lo(LeoDiskHandle_pulse)($t5)
/* 3E2BC 8003D6BC 3C0EA460 */  lui        $t6, %hi(PI_BSD_DOM2_PWD_REG)
/* 3E2C0 8003D6C0 3C0F8009 */  lui        $t7, %hi(LeoDiskHandle_pageSize)
/* 3E2C4 8003D6C4 ADCD0028 */  sw         $t5, %lo(PI_BSD_DOM2_PWD_REG)($t6)
/* 3E2C8 8003D6C8 91EF5566 */  lbu        $t7, %lo(LeoDiskHandle_pageSize)($t7)
/* 3E2CC 8003D6CC 3C18A460 */  lui        $t8, %hi(PI_BSD_DOM2_PGS_REG)
/* 3E2D0 8003D6D0 3C198009 */  lui        $t9, %hi(LeoDiskHandle_relDuration)
/* 3E2D4 8003D6D4 AF0F002C */  sw         $t7, %lo(PI_BSD_DOM2_PGS_REG)($t8)
/* 3E2D8 8003D6D8 93395567 */  lbu        $t9, %lo(LeoDiskHandle_relDuration)($t9)
/* 3E2DC 8003D6DC 3C08A460 */  lui        $t0, %hi(PI_BSD_DOM2_RLS_REG)
/* 3E2E0 8003D6E0 3C048009 */  lui        $a0, %hi(LeoDiskHandle)
/* 3E2E4 8003D6E4 3C018009 */  lui        $at, %hi(LeoDiskHandle_speed)
/* 3E2E8 8003D6E8 24845560 */  addiu      $a0, $a0, %lo(LeoDiskHandle)
/* 3E2EC 8003D6EC AD190030 */  sw         $t9, %lo(PI_BSD_DOM2_RLS_REG)($t0)
/* 3E2F0 8003D6F0 AC205570 */  sw         $zero, %lo(LeoDiskHandle_speed)($at)
