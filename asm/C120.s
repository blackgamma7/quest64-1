...
/* C278 8000B678 3C058008 */  lui        $a1, %hi(bossXPos)
/* C27C 8000B67C 24A5D1CC */  addiu      $a1, $a1, %lo(bossXPos)
...
/* C2B8 8000B6B8 3C058008 */  lui        $a1, %hi(bossXPos)
/* C2BC 8000B6BC 24A5D1CC */  addiu      $a1, $a1, %lo(bossXPos)
...
/* C2E0 8000B6E0 3C018008 */   lui       $at, %hi(bossXPos)
/* C2E4 8000B6E4 C42CD1CC */  lwc1       $f12, %lo(bossXPos)($at)
...
/* C878 8000BC78 3C018008 */  lui        $at, %hi(brianXPosToLoad)
/* C87C 8000BC7C E424BA40 */  swc1       $f4, %lo(brianXPosToLoad)($at)
...
/* C894 8000BC94 3C018007 */  lui        $at, %hi(Pi)
/* C898 8000BC98 C42811E0 */  lwc1       $f8, %lo(Pi)($at)
