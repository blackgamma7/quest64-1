...
#pragma GLOBAL_ASM("asm/nonmatchings/FA60/checkForKeyItems.s")

#pragma GLOBAL_ASM("asm/nonmatchings/FA60/UNK_calledWhenGettingNearDoor_RENAME.s")

#pragma GLOBAL_ASM("asm/nonmatchings/FA60/initLights_and_Fog.s")

#pragma GLOBAL_ASM("asm/nonmatchings/FA60/timeOfDaySomething.s")
...
#pragma GLOBAL_ASM("asm/nonmatchings/FA60/VOID_FUN_UNK_setsSeveralBytesToZero.s")

#pragma GLOBAL_ASM("asm/nonmatchings/FA60/UNK_NightHighlight_Something.s")
