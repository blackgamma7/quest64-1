...
/* 35460 80034860 3C048009 */  lui        $a0, %hi(viEventQueue)
/* 35464 80034864 3C058009 */  lui        $a1, %hi(viEventBuf)
/* 35468 80034868 24A551A8 */  addiu      $a1, $a1, %lo(viEventBuf)
...
/* 35514 80034914 3C0C8009 */  lui        $t4, %hi(viEventQueue)
/* 35518 80034918 3C0B8009 */  lui        $t3, %hi(viThread)
/* 3551C 8003491C 258C5190 */  addiu      $t4, $t4, %lo(viEventQueue)
/* 35520 80034920 240A0001 */  addiu      $t2, $zero, 1
/* 35524 80034924 256B3FE0 */  addiu      $t3, $t3, %lo(viThread)
...
/* 35588 80034988 3C048009 */  lui        $a0, %hi(viThread)
/* 3558C 8003498C 0C00CF0C */  jal        osStartThread
/* 35590 80034990 24843FE0 */   addiu     $a0, $a0, %lo(viThread)
...
.L80034AA8:
/* 356A8 80034AA8 3C198009 */  lui        $t9, %hi(__osViIntrCount)
/* 356AC 80034AAC 8F39562C */  lw         $t9, %lo(__osViIntrCount)($t9)
/* 356B0 80034AB0 8FA90028 */  lw         $t1, 0x28($sp)
/* 356B4 80034AB4 3C018009 */  lui        $at, %hi(__osViIntrCount)
/* 356B8 80034AB8 27280001 */  addiu      $t0, $t9, 1
/* 356BC 80034ABC 1120000C */  beqz       $t1, .L80034AF0
/* 356C0 80034AC0 AC28562C */   sw        $t0, %lo(__osViIntrCount)($at)
...
.L80034AF0:
/* 356F0 80034AF0 3C0B8009 */  lui        $t3, %hi(__osBaseCounter)
/* 356F4 80034AF4 8D6B5628 */  lw         $t3, %lo(__osBaseCounter)($t3)
/* 356F8 80034AF8 0C00FB64 */  jal        osGetCount
/* 356FC 80034AFC AFAB0024 */   sw        $t3, 0x24($sp)
/* 35700 80034B00 3C018009 */  lui        $at, %hi(__osBaseCounter)
/* 35704 80034B04 AC225628 */  sw         $v0, %lo(__osBaseCounter)($at)
/* 35708 80034B08 3C0E8009 */  lui        $t6, %hi(__osBaseCounter)
/* 3570C 80034B0C 8DCE5628 */  lw         $t6, %lo(__osBaseCounter)($t6)
/* 35710 80034B10 8FAF0024 */  lw         $t7, 0x24($sp)
/* 35714 80034B14 3C0B8009 */  lui        $t3, %hi(__osCurrentTime)
...
/* 35754 80034B54 AC2D5624 */   sw        $t5, %lo(__osCurrentTime)($at)
.L80034B58:
